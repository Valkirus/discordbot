  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    try {
      ...
      if (oldsetup.textchannel != "0") {
        try {
          message.guild.channels.cache
            ...
            .catch((e) =>
              console.log(
                "Couldn't delete msg, this is for preventing a bug".gray
              )
            );
        } catch {}
        try {
      ...
      message.guild.channels
        .create(`${client.user.username} Music - Requests`, {
          type: "category",
                ...
                try {
                  message.guild.channels
                    ...
                    .then(async (channel3) => {
                      ...
                      let embed1 = new MessageEmbed()
                        ...
                        .setTitle("หลวงพ่อ | Request | Guide")
                        .setDescription(
                      ...
                      let embed3 = new MessageEmbed()
                        ...
                        .setFooter(ee.footertext, ee.footericon)
                        .setTitle(
                          "หลวงพ่อ | Currently no song is playing!"
                        )
                        .setDescription(
                  ...
                  return message.channel.send(
                    new MessageEmbed()
                      ...
                      .setFooter(ee.footertext, ee.footericon)
                      .setTitle(
                        `${emoji.msg.ERROR} Error | Something went Wrong`
                      )
                      .setDescription(
